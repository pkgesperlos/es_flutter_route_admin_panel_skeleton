...
class _Login extends State<Login> {
              ...
              child: BootstrapContainer(
                ...
                children: [
                  BootstrapCol(
                      ...
                      offsets:
                          "offset-sm-0 offset-md-0 offset-lg-3 offset-xl-3",
                      child: Directionality(
                        ...
                        child: Container(
                          ...
                          margin:
                              EdgeInsets.all(PanelConstants.paddingDimension),
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.all(Radius.circular(
                                  PanelConstants.paddingDimension * 2)),
  ...
  void sendRequest() {
    ...
    logInBlocLogin.fetchLogin(
        apiAddress: "login",
        body: {"username": _ctrlUsername.text, "password": _ctrlPassword.text},
